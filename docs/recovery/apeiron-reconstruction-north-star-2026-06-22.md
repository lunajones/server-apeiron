...
3. `P0`: Convert runtime fallback suspicion into hard proof.
   ...
   - Remaining: classify remaining legacy DB compatibility surfaces and prove no normal boot path consumes recovery-only fixture data.
