...
1. `P0`: Restore creature brain architecture in `server-apeiron/internal/ai`.
   ...
   - Remaining: complete pass-through/contact/control response parity and Unreal grounding validation.
