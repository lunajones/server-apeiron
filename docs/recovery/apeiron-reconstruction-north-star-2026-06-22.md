...
1. `P0`: Restore creature brain architecture in `server-apeiron/internal/ai`.
   ...
   - Remaining: richer perception/threat inputs and complete creature action-root/pass-through/landing parity.
