...
Write-Host "game-server started with DB_APEIRON_ENDPOINT=$DbEndpoint MOVEMENT_VALIDATION=$env:MOVEMENT_VALIDATION CREATURE_RUNTIME_ENABLED=$env:CREATURE_RUNTIME_ENABLED"
